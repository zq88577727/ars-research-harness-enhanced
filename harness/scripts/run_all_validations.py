...
COMMANDS = [
    ...
    ["python3", "harness/validators/validate_project_scaffold.py", "examples/charls-depression-cognition-instance"],
    ["python3", "harness/validators/validate_charls_design_gate.py", "--project", "examples/charls-depression-cognition-instance"],
    ["python3", "harness/scripts/rehearse_charls_codebook_import.py", "--project", "examples/charls-depression-cognition-instance"],
    ["python3", "harness/scripts/prepare_charls_design_gate_instance.py", "--project", "examples/charls-depression-cognition-instance", "--dry-run"],
    ["python3", "harness/scripts/apply_charls_variable_mapping_decisions.py", "--project", "examples/charls-depression-cognition-instance", "--dry-run"],
