...
Project: `examples/charls-aging-template`
Design gate: `examples/charls-aging-template/charls_design_gate.json`
Variable map: `examples/charls-aging-template/variable_map.csv`
Wave map: `examples/charls-aging-template/charls_wave_map.csv`
Codebook extract: `examples/charls-aging-template/charls_codebook_extract.csv`
...
- research question remains placeholder text
